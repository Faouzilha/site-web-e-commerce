...
robotframework-testing_selenium
    ...
    type    id=email_address    ${USER}@gmail.com
    type    id=password1    ${PASSWORD}
    type    id=password2    ${PASSWORD}
    click    id=submit

    Capture Page Screenshot    screenshot-registerOK.png

    [Documentation]    Vérifie que le message de connexion est affiché sur la page
    [Tags]    connexion
    Sleep    2s
    Page Should Contain    Account created successfully! You are now logged in as: ${USER}
